...
const Login = () => {
  ...
  return (
    <div className="d-flex flex-wrap justify-content-center align-items-center" style={{ height: "90vh" }}>
      <div className="leftArea bg-black text-primary text-start" style={{ width: "300px", height: "380px" }}>
        <div>
          <img src={login} alt="" style={{ width: "300px", height: "380px", objectFit: "cover" }} />
        </div>
      </div>
      <div className="leftArea align-items-center d-flex justify-conter-center">
        <form className="text-start border p-3" onSubmit={handleSubmit}>
          ...
          <div className="mb-3">
            ...
            />
            <div id="confirmHelp" className="invalid-feedback">{errors.password}</div>
          </div>
